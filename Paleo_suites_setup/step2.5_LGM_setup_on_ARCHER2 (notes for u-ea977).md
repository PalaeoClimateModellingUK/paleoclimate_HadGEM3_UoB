...
?  Error from processor: 83
?  Error number: 11
????????????????????????????????????????????????????????????????????????????????

[83] exceptions: An non-exception application exit occured.
[83] exceptions: whilst in a serial region
[83] exceptions: Task had pid=53789 on host nid002603
[83] exceptions: Program is "/mnt/lustre/a2fs-work2/work/n02/n02/an25872/cylc-run/u-dz853_new/work/21541001T0000Z/coupled/./atmos.exe"
