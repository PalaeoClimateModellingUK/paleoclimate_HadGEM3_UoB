...
**notes:** If you plan to continue or restart an existing run (with ozone scheme open) that has already produced several years of output, it would be better to also update the initial ozone ancillary to the latest version.
